...
module.exports = {
    webpack: function(config, env) {
        ...
        // add HtmlWebpackPlugin to ftl.template
        // config.plugins[config.plugins.findIndex(i => i instanceof HtmlWebpackPlugin)] = new HtmlWebpackPlugin({
        //     inject: false,
        //     filename: path.resolve(__dirname, 'common.ftl'),
        //     templateContent: ({ htmlWebpackPlugin }) =>
        //         fs
        //             .readFileSync(path.resolve(__dirname, 'common.ftl.template'), { encoding: 'utf-8' })
        //             .replace('<%= htmlWebpackPlugin.tags.headTags %>', `${htmlWebpackPlugin.tags.headTags}`)
        //             .replace('<%= htmlWebpackPlugin.tags.bodyTag %>', `${htmlWebpackPlugin.tags.bodyTags}`),
        //     chunksSortMode: 'auto',
        //     minify: false,
        // });
