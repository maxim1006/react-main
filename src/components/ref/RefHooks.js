...
export default () => {
    ...
    return (
        <>
            <StyledRefLink href="/" onClick={onLinkClick(0)}>title 1</StyledRefLink>
            <StyledRefLink href="/" onClick={onLinkClick(1)}>title 2</StyledRefLink>
            <StyledRefLink href="/" onClick={onLinkClick(2)}>title 3</StyledRefLink>
