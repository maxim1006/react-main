...
export default function ShopCheckoutItem({ name, description, quantity, price, onRemove, onRemoveItem, onAddItem }) {
    return (
        <div className='shop-checkout-item'>
            ...
            <div className='shop-checkout-item__block'>
                {/* UTF-8 dingbats*/}
                <div className='shop-checkout-item__arrow' onClick={onRemoveItem}>
                    &#10094;
                </div>
                {quantity}
                <div className='shop-checkout-item__arrow' onClick={onAddItem}>
                    &#10095;
                </div>
            </div>
            <div className='shop-checkout-item__block'>{price}</div>
            <div className='shop-checkout-item__block' onClick={onRemove}>
