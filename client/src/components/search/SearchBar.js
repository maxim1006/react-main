        ...
        return (
            <form onSubmit={this.onFormSubmit}>
                <div className='search-bar'>
                    <input className='search-bar__input' value={inputValue} onChange={this.onInputChange} type='text' />
                    {this.props.children}
                    <br />
                    <input
                    ...
                    <br />
                    <textarea cols='30' rows='10' onChange={this.onTextareaChange} value={textareaValue} />
                    <br />
                    <input
                        type='radio'
                        name='test'
                    ...
                    radio 3
                    <br />
                    <input type='date' value={dateValue} onChange={this.onDateChange} />
                </div>
