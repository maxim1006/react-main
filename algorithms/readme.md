### процесс решения задач на алгоритмы
- прочти (как минимум 2ды) задачу, задай уточняющие вопросы
- напиши e2e псевдокод задачи
- напиши код
- попробуй его улучшить (эджкейсы, возможно другими решениями)
