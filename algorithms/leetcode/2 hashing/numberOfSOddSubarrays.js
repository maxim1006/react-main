...
// Удивляет что в мапе получается правильное количество подмассивов, но если разобраться то максимальное количество подмассивов nums.length (или right -left + 1), а в мапе лежат все нужные кейсы (потенциально их количество === nums.length) следовательно их количество и равно нужному количеству подмассивов
